			...
			<div className="flex justify-center gap-2">
				{otp.map((digit, index) => (
					<input
						...
						className="w-10 h-12 sm:w-11 sm:h-14 bg-slate-900/40 border border-white/15 rounded-xl text-center text-xl font-bold text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-inner"
					/>
				))}
			</div>
