...
import { StampZoomOverlay } from "@widgets/CreateInternalCorrespondence/ui/createInternalCorrespondence/StampZoomOverlay";
import {
  paginateHtml,
  contentStyle,
  CONTENT_CLASS,
...
export const DocumentCanvas = ({
  ...
  return (
    <>
      ...
      {/* Просмотр вшитого штампа ЭЦП в полном размере. */}
      <StampZoomOverlay
        src={zoomedStampSrc}
