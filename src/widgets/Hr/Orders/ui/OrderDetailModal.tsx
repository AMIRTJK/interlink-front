...
import { ArrowLeft, Pencil, X, ShieldCheck, Shield } from 'lucide-react';
import { If } from '@shared/ui/If';
import { IOrderRecord, ORDER_STATUS_LABELS } from '../model';
import { getStatusConfig, parseDate } from '../lib';
import { OrderDetailSidebar } from './orderDetailModal/OrderDetailSidebar';
    ...
    <div className="fixed inset-4 z-50 flex flex-col rounded-2xl bg-white shadow-2xl overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-slate-50/50 p-6">
        <div className="flex gap-6 h-full">
          ...
          <OrderDetailSidebar record={record} />
        </div>
      </div>
    </div>
  );
