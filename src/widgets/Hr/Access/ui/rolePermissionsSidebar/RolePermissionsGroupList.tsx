...
import { MODULE_TRANSLATIONS } from "./rolePermissionsSidebarModel";
...
interface IProps {
  ...
  rolePermissionsState: string[];
  onTogglePermission: (name: string) => void;
  onPageChange: (page: number) => void;
}

export function RolePermissionsGroupList({
  filteredGroups,
  paginatedGroups,
  sidebarPage,
  totalSidebarPages,
                ...
                return (
                  ...
                  >
                    ...
                    <Switch
                      size="small"
                      checked={checked}
                      onChange={() => onTogglePermission(act.name)}
                    />
                  </div>
                );
              })}
