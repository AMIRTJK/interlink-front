 ...
 * оформление, личный чат, группа) + зазоры (8) + отступы блока (40). Размеры
 * иконок одинаковые везде — под них подбирается ширина, а не наоборот.
 */
export const CHAT_LIST_PANEL_WIDTH = 310;

/** Та же ширина для всплывающего окна: там есть ещё «развернуть» и «закрыть». */
export const CHAT_LIST_PANEL_WIDTH_OVERLAY = 420;
