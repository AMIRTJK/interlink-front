...
export const RegistryHeader = memo(({
  taskCount,
  searchQuery,
  onSearchChange,
  sortConfig,
  ...
  return (
    <div className="px-6! py-4! border-b! border-zinc-200/50! dark:border-zinc-700/50! flex! items-center! gap-3! flex-wrap!">
      ...
      <div className="relative!">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-funnel"><path d="M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z"></path></svg>
            ...
            {Object.entries(sortLabels).map(([key, label]) => {
              ...
              return (
                ...
                >
                  <span>{label}</span>
                  <If is={isSelected}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-check"><path d="M20 6 9 17l-5-5"></path></svg>
                  </If>
                </button>
              );
            })}
      ...
      <button
        ...
        className={`flex! items-center! gap-2! bg-gradient-to-r! ${activeTheme.gradient} text-white! px-5! py-2.5! rounded-2xl! text-sm! font-semibold! shadow-lg! hover:shadow-xl! transition-all! duration-200! border-0! cursor-pointer!`}
      >
        <Plus size={16} />
