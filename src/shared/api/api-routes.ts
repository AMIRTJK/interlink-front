export const ApiRoutes = {
  ...
  // Комментарии письма: доступны всем участникам документа, постороннему
  // пользователю бэкенд отдаёт 403.
  GET_INTERNAL_COMMENTS: "/api/v1/internal-correspondences/:id/comments",
  CREATE_INTERNAL_COMMENT: "/api/v1/internal-correspondences/:id/comments",
